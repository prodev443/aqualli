        ...
        <div class="card-body">
                ...
                <div class="col-sm-6">
                    <div class="d-flex flex-row-reverse bd-highlight">
                        <div class="p-2 bd-highlight">
                            <a href="<?=base_url("students/detail/{$student['id']}")?>"><i class="bx bx-arrow-back"></i>
                                Regresar</a>
                        </div>
                    </div>
                </div>
            ...
            <form id="student_form">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="mb-3">
                            <label for="photo" class="form-label">Fotografía
                                <?= !empty($student['photo_path']) ? "| Este alumno ya tiene una foto" : "" ?></label>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="address_line"
                                name="address_line"><?=$student['address_line']?></textarea>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="address_postal_code" name="address_postal_code"
                                value="<?=$student['address_postal_code']?>">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="mb-3">
                    ...
                    <div class="col-md-2">
                        <div class="mb-3">
                            ...
                            <input type="checkbox" class="form-check-input" name="is_active"
                                <?=($student['is_active'] == 1) ? 'checked' : ''?> value="1">
