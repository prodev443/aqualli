                ...
                <form>
                    <div class="col-lg-4 mb-3">
                        <select id="module_selector" class="select2-search form-select" data-live-search="true">
                            ...
                            <option data-tokens="<?=$module['module_tag']?>" value="<?=$module['id']?>">
                                <?=$module['module_tag']?></option>
                            <?php endforeach;?>
                        </select>
                    </div>
                    <button type="button" class="btn btn-info btn-label" onclick="addPermission()">
                        <i class="bx bx-plus label-icon"></i>&nbsp;Módulo
                    </button>
                    <button type="button" class="btn btn-danger btn-label" onclick="deleteRows()">
                        <i class="bx bx-trash label-icon"></i>&nbsp;Eliminar
                    </button>
                    <button type="button" class="btn btn-success btn-label" onclick="saveRows()">
